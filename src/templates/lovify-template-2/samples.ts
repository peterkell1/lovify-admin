...
export const LOVIFY_TEMPLATE_2_SAMPLES: TemplateSample[] = [
  ...
  },
  {
    ...
    config: {
      ...
      required: true,
      options: [
        { value: 'clear_dreams', label: 'Clear on my dreams' },
        { value: 'believe_self', label: 'Believe in myself' },
        { value: 'great_attitude', label: 'Great attitude' },
      ],
    },
  },
  {
    ...
    config: {
      ...
      cta_label: 'Next step',
      options: [
        { value: 'love', label: 'Attract love into my life' },
        { value: 'career', label: 'Find my dream career' },
        { value: 'confidence', label: 'Become more confident' },
        { value: 'stress', label: 'Release stress and anxiety' },
        { value: 'wealth', label: 'Build real wealth' },
        { value: 'health', label: 'Improve my health and fitness' },
      ],
    },
  },
  {
